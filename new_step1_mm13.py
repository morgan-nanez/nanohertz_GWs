...
result_file = open("../../my_nano/fake_data/MM13_big_test.txt", "a+") # the a+ allows you to create the file and write to it.
stall_file = open("../../my_nano/fake_data/MM13_stalled_big_test.txt", "a+") #will collect data for the stalled binaries
